...
test_that("Test 1: Sample Size Comparison plot matches", {
	...
	jaspTools::expect_equal_plots(testPlot, "Test 1: sample-size-comparison", dir="auditClassicalPlanning")
})
...
test_that("Test 1: Implied Binomial Sampling Distribution plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 1: implied-binomial-sampling-distribution", dir="auditClassicalPlanning")
})
...
test_that("Test 2: Sample Size Comparison plot matches", {
	plotName <- results[["results"]][["planningContainer"]][["collection"]][["planningContainer_decisionPlot"]][["data"]]
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 2: sample-size-comparison", dir="auditClassicalPlanning")
})

test_that("Test 2: Implied Poisson Sampling Distribution plot matches", {
	plotName <- results[["results"]][["planningContainer"]][["collection"]][["planningContainer_samplingDistribution"]][["data"]]
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 2: implied-poisson-sampling-distribution", dir="auditClassicalPlanning")
})
...
test_that("Test 3: Sample Size Comparison plot matches", {
	plotName <- results[["results"]][["planningContainer"]][["collection"]][["planningContainer_decisionPlot"]][["data"]]
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 3: sample-size-comparison", dir="auditClassicalPlanning")
})

test_that("Test 3: Implied Hypergeometric Sampling Distribution plot matches", {
	plotName <- results[["results"]][["planningContainer"]][["collection"]][["planningContainer_samplingDistribution"]][["data"]]
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 3: implied-hypergeometric-sampling-distribution", dir="auditClassicalPlanning")
})
