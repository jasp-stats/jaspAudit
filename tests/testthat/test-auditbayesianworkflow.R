...
set.seed(1)
results <- jaspTools::runAnalysis("auditBayesianWorkflow", "test-auditBayesianWorkflow.csv", options)
...
test_that("Correlation Plot matches", {
	...
	jaspTools::expect_equal_plots(testPlot, "correlation-plot", dir="auditBayesianWorkflow")
})
...
test_that("Evaluation Information plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "evaluation-information", dir="auditBayesianWorkflow")
})
...
test_that("Sample Size Comparison plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "sample-size-comparison", dir="auditBayesianWorkflow")
})
...
test_that("Implied Prior from Risk Assessments plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "implied-prior-from-risk-assessments", dir="auditBayesianWorkflow")
})
...
test_that("Book Value Distribution plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "book-value-distribution", dir="auditBayesianWorkflow")
})
