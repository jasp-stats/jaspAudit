...
test_that("<b>Table 2.</b> Comparisons to Privileged (P) Group results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(
      "Male (P)", 0.642716146861429, 0.623700702880261, 0.661401080604867,
...
test_that("<b>Table 4.</b> Confusion Matrix results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(
      "Female", 0.593869731800766, "no", 656, 106, "", "", "yes", 258,
...
test_that("<b>Table 3.</b> Model Performance results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(
      0.690212765957447, 0.459940652818991, "Female", 0.593869731800766,
