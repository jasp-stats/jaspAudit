...
test_that("Model Performance table results match", {
	...
	jaspTools::expect_equal_tables(table,
		list(0.67244094488189, 0.706214689265537, "African_American", 0.665247472059606,
...
test_that("Model Fairness Summary - Predictive Rate Parity table results match", {
	...
	jaspTools::expect_equal_tables(table,
		list(231.16495878369, "African_American", 0.665247472059606, 0.643398855100595,
			 ...
			 0.615062397142818, "", 1, 1, 1, 0.103700796473506, "Hispanic",
