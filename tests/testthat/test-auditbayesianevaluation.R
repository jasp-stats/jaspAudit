...
test_that("Test 1: Evaluation Information plot matches", {
	...
	jaspTools::expect_equal_plots(testPlot, "Test 1: evaluation-information", dir="auditBayesianEvaluation")
})
...
test_that("Test 1: Prior and Posterior Distribution plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 1: prior-and-posterior-distribution", dir="auditBayesianEvaluation")
})
...
test_that("Test 2: Evaluation Information plot matches", {
	plotName <- results[["results"]][["evaluationContainer"]][["collection"]][["evaluationContainer_evaluationInformation"]][["data"]]
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 2: evaluation-information", dir="auditBayesianEvaluation")
})
...
test_that("Test 2: Prior and Posterior Distribution plot matches", {
	plotName <- results[["results"]][["evaluationContainer"]][["collection"]][["evaluationContainer_priorAndPosteriorPlot"]][["data"]]
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 2: prior-and-posterior-distribution", dir="auditBayesianEvaluation")
})
...
test_that("Test 3: Correlation Plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 3: correlation-plot", dir="auditBayesianEvaluation")
})

test_that("Test 3: Evaluation Information plot matches", {
	plotName <- results[["results"]][["evaluationContainer"]][["collection"]][["evaluationContainer_evaluationInformation"]][["data"]]
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 3: evaluation-information", dir="auditBayesianEvaluation")
})
...
test_that("Test 3: Prior and Posterior Distribution plot matches", {
	plotName <- results[["results"]][["evaluationContainer"]][["collection"]][["evaluationContainer_priorAndPosteriorPlot"]][["data"]]
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 3: prior-and-posterior-distribution", dir="auditBayesianEvaluation")
})
