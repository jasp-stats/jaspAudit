...
test_that("<b>Table 1.</b> Evaluation Summary results match", {
	...
	jaspTools::expect_equal_tables(table,
		list(211.088638102458, 0.05, 0.0125, 80, 0.0447299998232917, 1, 0.0572299998232917,
			 1))
})
...
test_that("<b>Table 1.</b> Evaluation Summary results match", {
	table <- results[["results"]][["evaluationContainer"]][["collection"]][["evaluationContainer_evaluationTable"]][["data"]]
	jaspTools::expect_equal_tables(table,
		list(7.96650501882257e-10, "40.035%", "20%", "50.602%", 83, "8.853%",
			 "50.602%", "61.115%", 42))
})
...
test_that("<b>Table 1.</b> Evaluation Summary results match", {
	table <- results[["results"]][["evaluationContainer"]][["collection"]][["evaluationContainer_evaluationTable"]][["data"]]
	jaspTools::expect_equal_tables(table,
		list(8282.04678073276, 70161, 17948.7381467551, 234, 27777.9530649518,
