...
set.seed(1)
results <- jaspTools::runAnalysis("auditClassicalWorkflow", "test-auditClassicalWorkflow.csv", options)
...
test_that("Correlation Plot matches", {
	...
	jaspTools::expect_equal_plots(testPlot, "correlation-plot", dir="auditClassicalWorkflow")
})
...
test_that("Evaluation Information plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "evaluation-information", dir="auditClassicalWorkflow")
})
...
test_that("Sample Size Comparison plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "sample-size-comparison", dir="auditClassicalWorkflow")
})
...
test_that("Implied Binomial Sampling Distribution plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "implied-binomial-sampling-distribution", dir="auditClassicalWorkflow")
})
...
test_that("Book Value Distribution plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "book-value-distribution", dir="auditClassicalWorkflow")
})
