...
test_that("Test 1: Book values plot matches", {
	...
	jaspTools::expect_equal_plots(testPlot, "Test 1: book-values", dir="auditSelection")
})
...
test_that("Test 3: Book values plot matches", {
	...
	testPlot <- results[["state"]][["figures"]][[plotName]][["obj"]]
	jaspTools::expect_equal_plots(testPlot, "Test 3: book-values", dir="auditSelection")
})
